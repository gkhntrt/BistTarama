...
if st.button("🔍 Tara"):
    ...
    if not results:
        ...
        for r in results:
            ...
            color = "green" if rİşte senin istediğin şekilde **tamamlanmış kod**; hem PD/DD, F/K ve piyasa değeri otomatik olarak Yahoo Finance’tan çekiliyor hem de grafiklere Bollinger Bands ve Stochastic Oscillator eklendi:
